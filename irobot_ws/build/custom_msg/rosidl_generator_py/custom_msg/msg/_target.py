...
class Target(metaclass=Metaclass_Target):
    ...
    _fields_and_field_types = {
        'target_pose': 'geometry_msgs/Vector3',
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import Vector3
        self.target_pose = kwargs.get('target_pose', Vector3())
        self.target_orientation = kwargs.get('target_orientation', float())
    ...
    def target_pose(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'target_pose' field must be a sub message of type 'Vector3'"
    ...
    def target_orientation(self, value):
        if __debug__:
            assert \
                ...
                "The 'target_orientation' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'target_orientation' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
