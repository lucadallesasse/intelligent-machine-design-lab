...
{
  new (message_memory) custom_msg::msg::Target(_init);
}

void Target_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_msg::msg::Target *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Target_message_member_array[2] = {
  {
    ...
    offsetof(custom_msg::msg::Target, target_pose),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msg::msg::Target, target_orientation),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::custom_msg::msg::rosidl_typesupport_introspection_cpp::Target_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msg, msg, Target)() {
  return &::custom_msg::msg::rosidl_typesupport_introspection_cpp::Target_message_type_support_handle;
}
